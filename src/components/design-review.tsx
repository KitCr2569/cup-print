    ...
    <div className="review-page">
      ...
      <main className="review-main">
        ...
        <div className="review-grid">
          <section className="review-artwork"><div className="review-artwork-head"><span>แบบของคุณ</span><small>DESIGN #{design.id.slice(0, 8).toUpperCase()}</small></div><div className="review-image-frame"><Image src={design.previewUrl} alt={`แบบพิมพ์ ${design.name}`} fill sizes="(max-width: 900px) 100vw, 60vw" unoptimized/></div><div className="review-specs"><span><small>พื้นที่พิมพ์</small><b>{design.printWidthCm} × {design.printHeightCm} ซม.</b></span><span><small>ความละเอียด</small><b>{design.dpi} DPI</b></span><span><small>รูปแบบ</small><b>พิมพ์รอบใบ</b></span></div></section>
